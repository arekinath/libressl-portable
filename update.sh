...
ggrep -v OPENSSL_ia32cap_P $libcrypto_src/Symbols.list | ggrep '^[[:alpha:]]' > crypto/crypto.sym
...
ggrep '^[[:alpha:]]' < $libtls_src/Symbols.list > tls/tls.sym
...
ggrep '^[[:alpha:]]' < $libssl_src/Symbols.list > ssl/ssl.sym
